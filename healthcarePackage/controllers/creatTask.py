...
def rec():
    ...
    time.sleep(8)
    tddown = config.driver.find_element_by_xpath('/html/body/div[11]/div/div/div/form/div/div/div[2]/div/fieldset/div/div[1]/div[2]/table/tbody/tr/td/div[2]/div/div/div').click()
    time.sleep(8)
    newTask1A = config.driver.find_element_by_xpath('/html/body/div[11]/div/div/div/form/div/div/div[2]/div/fieldset/div/div[1]/div[2]/table/tbody/tr/td/div[2]/div/div/div/div/ul/li[2]').click()
    #task date
    taskdate = config.driver.find_element_by_xpath('//*[@id="visitdate"]')
    taskdate.send_keys(plustaskdate)
    time.sleep(5)
    #Create button
    createbtn = config.driver.find_element_by_xpath('/html/body/div[11]/div/div/div/form/div/div/div[3]/div/button[2]').click()
    time.sleep(15) 
    patient_dashboard.gettab("task")
    time.sleep(15) 
